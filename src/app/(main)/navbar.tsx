...
export default function Navbar() {
  ...
  return (
    <div
      className={`w-[100vw] lg:w-full sticky top-0 ${
        addBg
    ...
    >
      <nav className="relative flex flex-wrap py-3 px-6 gap-1 items-center justify-between lg:justify-between max-w-7xl mx-auto">
              ...
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <div className="flex flex-col w-full bg-background/95 backdrop-blur-md rounded-lg p-4 shadow-xl border border-border">
                    ...
                    {/* Learning Lab switch — mobile (kept for quick access) */}
                    <Link
                      href="/learning-lab"
                      className="w-full capitalize px-2 py-2 rounded-md font-medium hover:bg-accent/10 hover:text-accent transition-all duration-200 flex items-center gap-2"
                      onClick={() => setIsOpen(false)}
                    >
                      Learning Lab
        ...
        {/* Desktop Right Side Buttons - removed duplicate Learning Lab link */}
